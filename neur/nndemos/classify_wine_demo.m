%% Wine Classification
% This demo illustrates how a pattern recognition neural network can
% classify wines by winery based on its chemical characteristics.

%   Copyright 2010-2011 The MathWorks, Inc.

%% The Problem: Classify Wines
% In this demo we attempt to build a neural network that can classify
...
%%
% This demo illustrated how to design a neural network that classifies
