...
%   $Revision: 1.1.8.11 $  $Date: 2011/05/09 00:58:45 $
...
%
% To recreate the data in *ovarian_dataset.mat* used in this demo, download
...
% following the steps in the demo *biodistcompdemo* (Batch processing with
...
% may lead to different and possibly improved results of this demonstration.
...
%
% Peformance is shown for each of the training, validation and test sets.
...
%%
% *<mailto:nnet-feedback@mathworks.com?subject=Feedback%20for%20CANCERDETECTDEMO%20in%20Bioinformatics%20Toolbox%202.1.1 Provide feedback for this demo.>*
