%% Maglev Modeling
% This demo illustrates how a NARX (Nonlinear AutoRegressive with eXternal
% input) neural network can model a magnet levitation dynamical system.

%   Copyright 2010-2011 The MathWorks, Inc.

%% The Problem: Model a Magnetic Levitation System
% In this demo we attempt to build a neural network that can predict the
...
%%
% This demo illustrated how to design a neural network that models
