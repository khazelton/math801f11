...
%   $Revision: 1.1.8.10 $  $Date: 2011/05/09 01:00:20 $
...
%
%%
% You need Bioinformatics Toolbox(TM) to run this demo. 

if ~nn_bioinfo.available
  errordlg('This demo requires Bioinformatics Toolbox.');
  return;
end
