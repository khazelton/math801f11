...
% This demo illustrates how a function fitting neural network can estimate
% median house prices for a neighborhood based on neighborhood demographics.

%   Copyright 2010-2011 The MathWorks, Inc.

%% The Problem: Estimate House Values
% In this demo we attempt to build a neural network that can estimate
...
%%
% This demo illustrated how to design a neural network that estimates
