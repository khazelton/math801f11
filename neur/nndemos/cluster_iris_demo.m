%% Iris Clustering
% This demo illustrates how a self-organizing map neural network can
...
% In this demo we attempt to build a neural network that clusters iris
...
%%
% This demo illustrated how to design a neural network that clusters
